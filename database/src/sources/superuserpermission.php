...
<body>
  ...
  <div class="container-fluid">
	...
	echo $fulltext;
      ...
      oci_close($conn);
      ?>
	<form action="txtreport.php" method="post">
				<input type="text" id="gizle3" name="report" value="'.$fulltext.'" style="display: none;">
				<input class="btn-danger" type="submit" value="txt report">
	</form>
    </div>
  </div>
</body>
